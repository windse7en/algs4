...
public class Point implements Comparable<Point> {
  ...
  public static void main(String[] args) {
    ...
    point1 = new Point(6000, 7000);
    point2 = new Point(10000, 0);
    point3 = new Point(3000, 7000);
    StdOut.println(point2.slopeTo(point1));
    StdOut.println(point2.slopeTo(point3));

    /* Horizontal line segments should be +0.0 */
    point1 = new Point(119, 369);
    point2 = new Point(308, 369);
